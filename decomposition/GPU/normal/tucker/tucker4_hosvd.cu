...
void tucker_hosvd4(dt *X,dt *core,dt *U1,dt *U2,dt *U3,dt *U4,long a,long b,long c,long d,long r1,long r2,long r3,long r4){
	...
	dim3 block1((a*b*c*d+512-1)/512,1,1); //for elepro
...
/*
	...
	cublasSgemm(handle,CUBLAS_OP_N,CUBLAS_OP_N,a,r2*r3*r4,r1,&alpha,d_X1_X1+(a-r1)*a,a,d_core,r1,&beta,d_coreU1,a);
	//a*r2*r3*r4  b*r2 coreU1U2
	cublasSgemmStridedBatched(handle,CUBLAS_OP_N,CUBLAS_OP_T,a,b,r2,&alpha,d_coreU1,a,a*r2,d_X2_X2+(b-r2)*b,b,0,&beta,d_coreU1U2,a,a*b,r3*r4);
	//a*b*r3*r4 c*r3  a*b*c*r4 coreU1U2U3
	cublasSgemmStridedBatched(handle,CUBLAS_OP_N,CUBLAS_OP_T,a*b,c,r3,&alpha,d_coreU1U2,a*b,a*b*r3,d_X3_X3+(c-r3)*c,c,0,&beta,d_coreU1U2U3,a*b,a*b*c,r4);
	//a*b*c*r4 d*r4 rec a*b*c*d
	cublasSgemm(handle,CUBLAS_OP_N,CUBLAS_OP_T,a*b*c,d,r4,&alpha,d_coreU1U2U3,a*b*c,d_X4_X4+(d-r4)*d,d,&beta,d_rec,a*b*c);

//	cublasSaxpy(handle,a*b*c*d,&alpha1,d_X,1,d_rec,1);
	elemin<<<block1,threads>>>(d_X,d_rec,a*b*c*d);
	cublasSnrm2(handle,a*b*c*d,d_rec,1,&sh);
	cout<<"sh "<<sh<<endl; 
	cublasSnrm2(handle,a*b*c*d,d_X,1,&xia);
	cout<<"xia "<<xia<<endl; 
	cudaDeviceSynchronize();
