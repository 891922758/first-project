...
void tucker_tensorcore(dt *X,dt *core,dt *U1,dt *U2,dt *U3,long a,long b,long c,long r1,long r2,long r3){
	...
	dim3 block1((a*b*c+512-1)/512,1,1); //for X2'
...
//	cublasSetMathMode(handle,CUBLAS_TENSOR_OP_MATH);
	...
	tensorToMode2<<<block1,threads>>>(d_X,d_X2,a,b,c);
	cudaDeviceSynchronize();
...
//cout<<infogpu<<endl;
	cudaFree(d_work);
	cudaDeviceSynchronize();
//cout<<"second vectors"<<endl; printTensor(d_X2_X2+(b-r2)*b,2,3,1);
...
//cout<<infogpu<<endl;
//cudaDeviceSynchronize();
//cout<<"third vectores"<<endl; printTensor(d_X3_X3+(c-r3)*c,2,3,1);
	cudaFree(d_W1);
	cudaFree(d_W2);
	cudaFree(d_W3);
...
cout<<"coreU1"<<endl; printTensor(d_coreU1,2,3,1);
...
cout<<"coreU1U2"<<endl; printTensor(d_coreU1U2,2,3,1);
...
cout<<"d_X"<<endl; printTensor(d_X,5,1,1);
cout<<"d_rec"<<endl; printTensor(d_rec,5,1,1);
//	cublasSaxpy(handle,a*b*c,&alpha1,d_X,1,d_rec,1);
	elemin<<<block1,threads>>>(d_X,d_rec,a*b*c);
//cout<<"d_X"<<endl; printTensor(d_X,1,5,1);
//cout<<"d_rec"<<endl; printTensor(d_rec,1,5,1);
